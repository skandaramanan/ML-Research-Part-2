...
Two-task image classification (Task 1: 5-class coarse; Task 2: 10-class fine-grained birds).
...
4. `notebooks/03_task2_models.ipynb` — Task 2 models including the required ensemble, 5-fold CV, Kaggle CSV.
